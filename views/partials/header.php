        ...
        <div data-aos="fade-down" data-aos-duration="1500" class="flex flex-col max-w-screen-xl px-8 mx-auto md:items-center md:justify-between md:flex-row">
            <div class="flex flex-row items-center justify-between py-6">
                <div class="relative md:mt-8">
                    <a href="/budget-management/" class="text-lg relative z-50 font-bold tracking-widest text-gray-900 rounded-lg focus:outline-none focus:shadow-outline">SpendWise</a>
            ...
            <nav :class="{ 'transform md:transform-none': !open, 'h-full': open }" class="h-0 md:h-auto flex flex-col flex-grow md:items-center pb-4 md:pb-0 md:flex md:justify-end md:flex-row origin-top duration-300 scale-y-0">
                ...
                <a  href="/budget-management/views/auth/login.php"><button class="px-10 py-3 mt-2 text-sm font-bold text-center border border-yellow-500 bg-white hover:bg-yellow-500 hover:text-white transition-all ease-in text-gray-800 rounded-full md:mt-8 md:ml-4">Login</button></a>
                <a  href="/budget-management/views/auth/register.php"><button class="px-10 py-3 mt-2 text-sm font-bold text-center bg-yellow-500 hover:bg-white  text-white hover:text-black transition-all ease-in rounded-full md:mt-8 md:ml-4">Sign Up</button></a>
            </nav>
        </div>
</header>