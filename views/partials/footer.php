<footer class="mt-32" style="background-color: rgba(37, 38, 65, 1);">
		<div class="max-w-lg mx-auto">
			<div class="flex py-12 justify-center gap-5 text-white items-center px-20 sm:px-36">
				<div class="relative w-1/2">
					<h1 class="font-bold text-xl pr-5 relative z-50">SpendWise</h1>
				...
				<span class="w-1/2 border-l border-gray-500 text-sm pl-5 py-2 font-semibold">Smarter financial decisions start here</span>
			</div>
			<div class="text-center pb-16 pt-5">
				...
				<div class="px-5 sm:px-0 flex flex-col sm:flex-row sm:space-x-3 space-y-3 sm:space-y-0 justify-center mt-3">
					...
					<button type="submit" class="text-white w-40 sm:w-auto mx-auto sm:mx-0 font-semibold px-5 py-2 rounded-full bg-yellow-400" >Subscribe</button>
				</div>
			</div>
			...
			<div class="text-center text-white">
				<p class="my-3 text-gray-400 text-sm">&copy; 2025  Spendee. All rights reserved. </p>
				<div class="py-3 tracking-wide">
					<p>Code By <span class="font-semibold">Amine IBOUHA</span></p>
					<p>UI/UX By <span class="font-semibold">Amine IBOUHA</span></p>
				</div>
			</div>
		</div>
	</footer>